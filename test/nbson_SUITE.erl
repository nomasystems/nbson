...
proplists(_Config) ->
    ...
    <<46, 0, 0, 0, 4, 97, 114, 114, 0, 36, 0, 0, 0, 16, 48,
      0, 1, 0, 0, 0, 2, 49, 0, 4, 0, 0, 0, 116, 119, 111,
      0, 2, 50, 0, 6, 0, 0, 0, 116, 104, 114, 101, 101, 0, 0, 0>> =
    nbson:encode([{<<"arr">>, [1, <<"two">>, <<"three">>]}]),

    <<64,0,0,0,4,97,114,114,0,54,0,0,0,16,48,0,1,0,0,0,2,49,0,
      4,0,0,0,116,119,111,0,2,50,0,6,0,0,0,116,104,114,101,
      101,0,3,51,0,15,0,0,0,16,102,111,117,114,0,4,0,0,0,0,0,0>> =
